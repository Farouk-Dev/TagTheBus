    ...
    public Location checkIfLocationAvailable()
    {
        try
        {
            ...
            if(!isGPSOn && !isNetWorkEnabled)
            {
                ...
                if(isNetWorkEnabled)
                {
                    locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER,MIN_TIME_FOR_UPDATES,MIN_DISTANCE_TO_REQUEST_LOCATION, (android.location.LocationListener) this);
                ...
                if(isGPSOn)
                {
                    locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER,MIN_TIME_FOR_UPDATES,MIN_DISTANCE_TO_REQUEST_LOCATION, (android.location.LocationListener) this);
